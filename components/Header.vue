...
<nav class="mainNav">
  ...
  <ul class="mainNav__nav">
    ...
    <li><a @click="showMenu = !showMenu" href="#">MORE<span>+</span></a>
      ...
      >
      <ul v-if="showMenu" class="mainNav__nav__submenu"  >
      <li><nuxt-link to="/blog" @click="showMenu = false">News</nuxt-link></li>
       <li><nuxt-link to="/blog/single-post" @click="showMenu = false">Single Post</nuxt-link></li>
         <li><nuxt-link to="/support-resources" @click="showMenu = false">Support &amp; Resources</nuxt-link></li>
           <li><nuxt-link to="/request-sample" @click="showMenu = false">Request a Free Sample</nuxt-link></li>
       <div class="hidden">      <li>Support &amp; Resources</li>
      <li>
        <a href="#">
